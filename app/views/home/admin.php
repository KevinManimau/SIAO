  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">DATA SELURUH CABANG</h4>
        </div>
     </div>
     <div class="row">
       <div class="col-lg-6">
    ...
    <!-- Kinerja -->
     <div class="row">
        <div class="col-lg-6">
          <div class="card">
            <div class="card-header uppercase"><i class="fa fa-table"></i> TABEL KINERJA CABANG <span class="dateTarget text-danger"><?=date('M Y');?></span></div>
            <div class="card-body">
              <div class="table-responsive">
              <table id="advTable" class="text-center table table-bordered">
