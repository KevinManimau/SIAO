  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        <div class="col-sm-9">
		    <h4 class="page-title">KREDIT DARI ACCOUNT OFFICER</h4>
        </div>
        <div class="col-sm-3 text-right">
        <button type="button" class="btnadd align-right btn btn-primary waves-effect waves-light" data-toggle="modal" data-target="#DataModels"><i class="fa fa-plus mr-3"></i>Tambah Kredit</button>
        </div>
     </div>
     <div class="row">
       <div class="col-lg-6">
    ...
    <!-- End Breadcrumb-->
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-header"><i class="fa fa-table"></i>DATA KREDIT DARI AO</div>
            <div class="card-body">
