  ...
  <div class="content-wrapper">
    <div class="container-fluid">
     ...
     <div class="row pt-2 pb-2">
        ...
        <button type="button" class="btnadd align-right btn btn-primary waves-effect waves-light tampilModalTambahAnggota" data-toggle="modal" data-target="#DataModalAnggota"><i class="fa fa-plus mr-3"></i>Tambah ANGGOTA</button>
        </div>
     </div>
     <div class="row">
       <div class="col-lg-6">
              ...
              <table id="example" class="text-center table table-bordered">
                ...
                <?php $i=1;?>
                  ...
                  <tr>
                    ...
                    <td><?=$agt['wilayah']?></td>
                    <!-- <td>
                    <h5 class="text-info">No Action</h5>
                    </td> -->
                  </tr>
                  <?php $i++;?>
                  <?php endforeach;?>
                  ...
                  <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content animated lightSpeedIn">
                      <div class="modal-header">
                        <h5 class="modal-title" id="forModalLabel">Tambah Anggota</h5>
                      ...
                      <div class="modal-body">
                          <form action="<?=BASEURL?>Anggota/tambah" method="post" enctype="multipart/form-data">
                            ...
                            <div class="input-group mb-3">
                              ...
                              <select class="custom-select" id="cabang" name="cabang" data-id="">
                                <option id="choose" selected>Choose...</option>
                                <?php foreach($data['cbg'] as $cbg):?>
                                  <option class="mycabang" value="<?=$cbg['id']?>" data-id="<?=$cbg['id']?>"><?=$cbg['nama_cab']?></option>
                                <?php endforeach;?>
                              </select>
                            </div>
                            <div class="input-group mb-3">
